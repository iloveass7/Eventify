                    ...
                    <div key={event.id} className="bg-white rounded-lg shadow-lg hover:shadow-xl transition-shadow flex flex-col h-full">
                      ...
                      <div className="p-4 sm:p-6 flex flex-col flex-grow">
                        ...
                        <div className="mt-auto">
                          <button className="w-full bg-purple-600 text-white py-2 sm:py-3 px-4 sm:px-6 text-sm sm:text-base lg:text-lg rounded-lg hover:bg-purple-900 transition-colors font-medium">
