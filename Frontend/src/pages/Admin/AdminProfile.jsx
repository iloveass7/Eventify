  ...
  return (
    <div className="max-w-8xl mx-2 py-10">
      ...
      >
        {/* Profile Header */}
        <div
          className={`px-6 py-8 transition-colors duration-500 ${
            isDarkMode
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          className={`w-full px-3 py-2 pr-10 border rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-colors duration-500 ${
                            isDarkMode
                              ? "bg-gray-700 border-gray-600 text-gray-100"
                              : "bg-white border-gray-300 text-gray-900"
                          }`}
