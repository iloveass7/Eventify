...
const EventDetails = () => {
  ...
  const event = {
    ...
    description:
      "Join us for the biggest tech event of the year featuring AI, blockchain, and web development workshops. This summit brings together industry leaders, innovators, and students to explore the latest trends in technology.",
    longDescription: `
    ...
    organizer: {
      ...
      description:
        "The official Computer Science Club of the university, dedicated to fostering innovation and learning in technology.",
      contact: {
    ...
    speakers: [
      ...
      },
      {
        ...
        role: "Blockchain Developer, Microsoft",
        image:
  ...
  return (
    ...
    >
      ...
      >
        <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8 py-4 text-lg">
      ...
      <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        >
          ...
          <div className="p-6">
            ...
            <div className="mb-6">
              <div
                className={`flex justify-between text-sm mb-2 transition-colors duration-500 ${
                  isDarkMode ? "text-gray-500" : "text-gray-600"
                }`}
              >
            ...
            {isRegistered ? (
              <div
                className={`flex items-center gap-3 p-4 rounded-lg transition-colors duration-500 ${
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-4">
            <div
              className={`rounded-lg shadow-lg p-8 transition-colors duration-500 ${
                isDarkMode ? "bg-gray-800" : "bg-white"
              }`}
            >
              <h2
              ...
              <div
                className={`prose prose-lg max-w-none leading-relaxed transition-colors duration-500 ${
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {event.speakers.slice(0, 2).map((speaker, index) => (
                  <div key={index} className="text-center group">
                    ...
                    <p
                      className={`text-lg mb-2 transition-colors duration-500 ${
                        isDarkMode ? "text-gray-400" : "text-gray-600"
                      }`}
                    >
                      {speaker.role}
          ...
          <div className="space-y-4">
            ...
            >
              ...
              <div className="space-y-3">
                ...
                <div
                  className={`flex items-center gap-3 pt-3 border-t transition-colors duration-500 ${
            ...
            >
              ...
              <div className="space-y-4">
                ...
                >
                  ...
                  <span
                    className={`px-4 py-2 rounded-full text-sm font-medium transition-colors duration-500 ${
                      isDarkMode
            ...
            {/* Organizer Card */}
            <div
              className={`rounded-lg shadow-lg pt-8 pb-5 px-8 transition-colors duration-500 ${
                isDarkMode ? "bg-gray-800" : "bg-white"
              }`}
            >
              ...
              <div className="space-y-4">
                ...
                <div
                  className={`border-t pt-2 space-y-3 transition-colors duration-500 ${
                    isDarkMode ? "border-gray-700" : "border-gray-100"
                  }`}
                >
                  <div className="flex items-center gap-3">
